                                                ...
                                                <div class="col-3">
                                                    <div class="form-group">
                                                        <select name="kode_dept" id="kode_dept" class="form-select">
                                                            <option value="">Bagian pendidik</option>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" id="nik"
                                        class="form-control" placeholder="Username" name="nik">
                                </div>
                            </div>
                        </div>
                        <div class="row">
        ...
        $(function() {
            ...
            $("#frmKaryawan").submit(function() {
                ...
                if (nik == "") {
                    ...
                    Swal.fire({
                        title: 'Warning!',
                        text: 'Bagian pendidik Harus Diisi !',
                        icon: 'warning',
                        confirmButtonText: 'Ok'
                    }).then((result) => {
                        $("#kode_dept").focus();
                    ...
                    Swal.fire({
                        title: 'Warning!',
                        text: 'Lokasi sekolah Harus Diisi !',
                        icon: 'warning',
                        confirmButtonText: 'Ok'
                    }).then((result) => {
                        $("#kode_cabang").focus();
